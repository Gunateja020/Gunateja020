...
Recent Master's graduate in Data Science from Arden University, Berlin. I specialize in machine learning, time-series forecasting, and end-to-end model development. My thesis focused on flight delay prediction using XGBoost and LSTM models on 140K+ aviation records, achieving projected cost savings of $140K+.

Currently seeking **Junior Data Scientist**, **Data Analyst**, or **Machine Learning Engineer** roles in Germany.
